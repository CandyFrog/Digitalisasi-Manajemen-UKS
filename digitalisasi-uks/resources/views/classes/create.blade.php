<x-app-layout>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden max-w-2xl">
        <div class="p-6 border-b border-gray-100">
            ...
            <p class="text-sm text-gray-500 mt-1">Silakan masukkan nama kelas baru.</p>
        </div>
        ...
        <form action="{{ route('classes.store') }}" method="POST" class="p-6">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nama_kelas" id="nama_kelas" value="{{ old('nama_kelas') }}" class="w-full rounded-lg border-gray-300 focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition duration-150" placeholder="Contoh: X RPL 1" required>
                @error('nama_kelas')
